...
# on your K/X/Ubuntu desktop system.
...
libheif-dev libi2c-dev libibus-1.0-dev libinput-dev libinput-tools libjpeg-dev \
...
# e.g. cp -aR /home/riley/Documents/ebackups/E_1683818126 .e* /home/riley/
